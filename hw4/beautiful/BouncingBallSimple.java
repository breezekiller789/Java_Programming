...
public class BouncingBallSimple extends JPanel {
   ...
   private float ballSpeedX = 8;   // Ball's speed for x and y
   private float ballSpeedY = 11;
   ...
   public static void main(String[] args) {
      ...
      javax.swing.SwingUtilities.invokeLater(new Runnable() {
         public void run() {
            ...
            JFrame frame = new JFrame("JavaProgramming HW4 405410100 黃晉威 Bouncing Balls簡單版");
