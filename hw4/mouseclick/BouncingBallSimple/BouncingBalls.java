...
public class BouncingBalls extends JPanel implements MouseListener {
    ...
    public void mousePressed(MouseEvent e) {
        ...
        if(BallCount < 1){
            ...
            System.out.println("Ball Count Limit 1 exceeded");
        }
    }
    ...
    public static class Ball {
        ...
        //  隨機產生他的初始位置和速度。
        int speedX = GetRandomInteger(30);    //  球在X方向上前進的速度
        int speedY = GetRandomInteger(30);    //  球在Y方向上前進的速度
        int xPosition = GetRandomInteger(480);//  球初始的X位置
        int yPostion = GetRandomInteger(480); //  球初始的Y位置
        int RADIUS = 50;
        ...
        public void draw(Graphics myGraphics) {
            ...
            myGraphics.setColor(new Color(0, 0, 255));
